...
public class SwipeItemLayout extends FrameLayout {
    ...
    public void addMenus(View menuView) {

        FrameLayout.LayoutParams layoutParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT, Gravity.RIGHT);
        addView(menuView, getChildCount(),layoutParams);
        mMenus.put(Gravity.RIGHT, menuView);
    }
